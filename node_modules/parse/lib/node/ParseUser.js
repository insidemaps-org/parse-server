...
var DefaultController = {
  ...
  linkWith: function linkWith(user, authData) {
    //NOTE: Master key is needed to login user in cloud code with OAuth authentication data.
    return user.save({ authData: authData }, {useMasterKey:true}).then(function () {
      if (canUseCurrentUser) {
        return DefaultController.setCurrentUser(user);
      }
      return user;
