...
export class ClassesRouter extends PromiseRouter {
  ...
  handleFind(req) {
    ...
    return rest.find(req.config, req.auth, req.params.className, body.where, options, req.info.clientSDK, req)
      .then((response) => {
  ...
  handleGet(req) {
    ...
    return rest.get(req.config, req.auth, req.params.className, req.params.objectId, options, req.info.clientSDK, req)
      .then((response) => {
  ...
  handleCreate(req) {
    return rest.create(req.config, req.auth, req.params.className, req.body, req.info.clientSDK, req);
  }

  handleUpdate(req) {
    return rest.update(req.config, req.auth, req.params.className, req.params.objectId, req.body, req.info.clientSDK, req);
  }

  handleDelete(req) {
    return rest.del(req.config, req.auth, req.params.className, req.params.objectId, req.info.clientSDK, req)
      .then(() => {
        return {response: {}};
      });
  }
